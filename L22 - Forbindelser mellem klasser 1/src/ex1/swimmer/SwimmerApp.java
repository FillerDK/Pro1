...
public class SwimmerApp {
    ...
    public static void main(String[] args) {
        ...
        for (Swimmer s : swimmers) {
            ...
            System.out.println(printSwimmer(s));
        }
    }

    public static String printSwimmer(Swimmer swimmer) {
        return String.format("Name: %s, training hours weekly: %d", swimmer.getName(), swimmer.allTrainingHours());
    }
}
